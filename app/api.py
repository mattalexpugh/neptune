...
import algorithms.correction
import algorithms.features

from algorithms.learning import CLASSIFIER_MAP
from experiments import EXPERIMENT_MAP


METHOD_MAP = {
    'correction': algorithms.correction.METHOD_MAP,
    'features': algorithms.features.METHOD_MAP
}
...
class APIExperiments(APIBaseGenerator):

    def __init__(self):
        super(APIExperiments, self).__init__(method_map=EXPERIMENT_MAP)
...
class APIHolder(object):
    ...
    def experiments(self):
        return self.everything['experiments']
    ...
    @property
    def structure(self):
        yield "API Version {}".format(APIBaseGenerator.VERSION)
